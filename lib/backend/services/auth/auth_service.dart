...
mixin AuthService{
  ...
  ///* resendEmail api services
  Future<CommonSuccessModel?> resendEmailApi(
      {required Map<String, dynamic> body}) async {
    Map<String, dynamic>? mapResponse;
    try {
      ...
      log.e(':ladybug::ladybug::ladybug: err from resendEmailApi service ==> $e :ladybug::ladybug::ladybug:');
      CustomSnackBar.error('Something went Wrong!');
      return null;
    }
    return null;
