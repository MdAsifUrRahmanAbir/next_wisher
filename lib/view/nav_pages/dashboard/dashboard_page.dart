      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
              borderRadius:
              BorderRadius.circular(Dimensions.radius * .8),
                ...
                children: [
                  ...
                  Expanded(
                    child: TitleHeading4Widget(
                      text: "Find a celebrity", color: Colors.white, fontWeight: FontWeight.w600,),
                  ),
                ],
              ),
              verticalSpace(Dimensions.paddingSizeVertical * .2),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: TitleHeading4Widget(
                      text: "Submit your request", color: Colors.white, fontWeight: FontWeight.w600,),
                  ),
                ],
              ),
              verticalSpace(Dimensions.paddingSizeVertical * .2),
              TitleHeading5Widget(
                  text: "Tell them what you want to include in the video.", color: Colors.white),
            ],
          ),
        ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: TitleHeading4Widget(
                      text: "Get your video", color: Colors.white, fontWeight: FontWeight.w600,),
                  ),
                ],
              ),
              verticalSpace(Dimensions.paddingSizeVertical * .2),
              TitleHeading5Widget(
                  text: "It takes up to 5 days to complete your request. When ready, you will get it in your inbox.", color: Colors.white),
            ],
          ),
        ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: TitleHeading4Widget(
                      text: "Enjoy", color: Colors.white, fontWeight: FontWeight.w600,),
                  ),
                ],
              ),
              verticalSpace(Dimensions.paddingSizeVertical * .2),
              TitleHeading5Widget(
                  text: "Enjoy your video and share it with friends and family.", color: Colors.white),
            ],
          ),
        ),
        verticalSpace(Dimensions.paddingSizeVertical * .2),
